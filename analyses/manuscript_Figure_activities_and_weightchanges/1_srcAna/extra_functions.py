...
def plot_column(title, col, selections, weights_sd1, weights_sd2, weights_stn, post_switch_trials, bold_font):
    """
    ...
    if col==0:
        ...
        plt.plot(trials, weights_sd2[:,1], color='k', ls='dotted', label='old rewarded')
